...
import { Plane, MapPin, Palmtree, Car } from "lucide-react";
      ...
      <div className="container px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, i) => (
            <motion.div
              key={service.title}
              className="bg-card rounded-2xl p-8 border border-border hover:shadow-gold hover:border-gold/30 transition-all duration-300 group"
